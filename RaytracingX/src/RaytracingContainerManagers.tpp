    ...
    *d_min_dt = std::numeric_limits<CCTK_REAL>::max();
    ...
    {   
        ...
        {   
            ...
            if (dt1 > max_dx) { fprintf(stderr, "E=%f/%f=%f\n", exp(lnE[i]), lapse_x, exp(lnE[i])/lapse_x); particles[i].id() = -1; del_rsn[i] = DelReason::UNSTABLE; dt[i] = dt1; return; }
            ...
            if (dt2 > max_dx) { fprintf(stderr, "E=%f/%f=%f\n", exp(lnE[i]), lapse_x, exp(lnE[i])/lapse_x); particles[i].id() = -1; del_rsn[i] = DelReason::UNSTABLE; dt[i] = dt2; return; }
            ...
            if (dt3 > max_dx) { fprintf(stderr, "E=%f/%f=%f\n", exp(lnE[i]), lapse_x, exp(lnE[i])/lapse_x); particles[i].id() = -1; del_rsn[i] = DelReason::UNSTABLE; dt[i] = dt3; return; }
            ...
            if (dt4 > max_dx) { fprintf(stderr, "E=%f/%f=%f\n", exp(lnE[i]), lapse_x, exp(lnE[i])/lapse_x); particles[i].id() = -1; del_rsn[i] = DelReason::UNSTABLE; dt[i] = dt4; return; }
