...
namespace RaytracingX
{
    ...
    public:
                ...
                const amrex::GpuArray<double, 3> &phi)
        {
            ...
            if (amrex::ParallelDescriptor::MyProc == 13 && index == 12053) { fprintf(stderr, "%f %f %f %f\n", this->mass, std::exp(u[3 + StructType::ln_alphaE]), v, this->mass * this->mass / (2*std::exp(u[3 + StructType::ln_alphaE]))); }
      ...
      if (out_of_bounds) {
         ...
         *  @param max_energy RaytracingX: Maximum energy threshold for event horizon detection.
         */
        void evolve_k1(const amrex::MultiFab &lapse,
                       const amrex::MultiFab &shift,
                       const amrex::MultiFab &metric,
                       const amrex::MultiFab &curv,
                       const amrex::MultiFab &rho,
      ...
      LOAD_RK4_VARS
         ...
         *  @param max_energy RaytracingX: Maximum energy threshold for event horizon detection.
         */
        void evolve_k2(const amrex::MultiFab &lapse,
                       const amrex::MultiFab &shift,
                       const amrex::MultiFab &metric,
                       const amrex::MultiFab &curv,
                       const amrex::MultiFab &rho,
      ...
      LOAD_RK4_VARS
         ...
         *  @param max_energy RaytracingX: Maximum energy threshold for event horizon detection.
         */
        void evolve_k3(const amrex::MultiFab &lapse,
                       const amrex::MultiFab &shift,
                       const amrex::MultiFab &metric,
                       const amrex::MultiFab &curv,
                       const amrex::MultiFab &rho,
      ...
      if (out_of_bounds) {
         ...
         *  @param max_energy RaytracingX: Maximum energy threshold for event horizon detection.
         */
        void evolve_k4(const amrex::MultiFab &lapse,
                       const amrex::MultiFab &shift,
                       const amrex::MultiFab &metric,
                       const amrex::MultiFab &curv,
                       const amrex::MultiFab &rho,
