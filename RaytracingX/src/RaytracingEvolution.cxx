...
extern "C" void R_ParticlesContainer_evolve(CCTK_ARGUMENTS)
{
  ...
  if (CCTK_MyProc(cctkGH) == 0) { fprintf(stderr, m.to_string() + "interp. at (%f, %f, %f)", -1.853942, 15.130371, -0.154485); }
  interpolateMetricAtPoint2(CCTK_PASS_CTOC, &m, -32.010824, -31.163003, 16.099812);
  if (CCTK_MyProc(cctkGH) == 0) { fprintf(stderr, m.to_string() + "interp. at (%f, %f, %f)", -32.010824, -31.163003, 16.099812); }
