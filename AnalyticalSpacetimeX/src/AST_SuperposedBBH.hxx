...
#ifndef AST_SUPERPOSEDBBH_HXX
#define AST_SUPERPOSEDBBH_HXX
...
SuperposedBBH(const double *xx, double gcov[][NDIM], const double *traj_array,
              const double AST_adjust_mass1, const double AST_adjust_mass2,
              const double AST_a1_buffer, const double AST_a2_buffer,
              const double AST_cutoff_floor,
              bool &mask) {
  ...
  double x1BH1 = (oo18 + x) -
                 oo20 * (oo5 * (v1x * (((oo18 + x) * v1x +
                                        ((oo21 + y) * v1y + (oo22 + z) * v1z)) *
                                       oo19)));
  double x1BH2 =
      (oo23 + x) -
      oo24 *
          (oo25 *
           (v2x * (((oo23 + x) * v2x + ((oo26 + y) * v2y + (oo27 + z) * v2z)) *
                   oo15)));
...
#endif // #ifndef AST_SUPERPOSEDBBH_HXX
