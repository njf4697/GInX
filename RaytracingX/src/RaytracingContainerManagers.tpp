    ...
    const CCTK_REAL max_energy)
{
    ...
    {   
        ...
        CCTK_REAL *AMREX_RESTRICT p_upt = attribs[StructType::p_upt].data();
        ...
        amrex::ParallelFor(np, [=] AMREX_GPU_DEVICE(int i) noexcept
        {
            ...
            p_upt[i] = exp(ln_energy[i]) / lapse_x;
    ...
    *d_min_dt = std::numeric_limits<CCTK_REAL>::max();
    ...
    {   
        ...
        {   
            ...
            dt[i] = sqrt(dxvecdt[0]*dxvecdt[0] + dxvecdt[1]*dxvecdt[1] + dxvecdt[2]*dxvecdt[2]);
