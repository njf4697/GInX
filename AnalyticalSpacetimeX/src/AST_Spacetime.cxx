...
void GetMetricAtPoint(
    const double *xx,
    const double *bbh_traj,
    four_metric *met)
{
    double gcov[NDIM][NDIM];
    ...
    case metric_t::kerrschild:
        KerrSchild(xx, gcov,
                   AST_KerrSchild__mass,
                   AST_KerrSchild__spin);
        break;

    case metric_t::superposed_bbh:
        SuperposedBBH(xx, gcov, bbh_traj,
                      AST_adjust_mass1,
                      AST_adjust_mass2,
                      AST_a1_buffer,
                      AST_a2_buffer,
    ...
    case metric_t::vertical_gravity:
        VerticalGravity(xx, gcov, bbh_traj,
                        AST_VerticalGravity_z0,
                        AST_VerticalGravity_g);
        break;
    }
